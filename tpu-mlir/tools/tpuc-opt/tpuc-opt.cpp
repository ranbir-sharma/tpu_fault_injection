...
#include "../../include/LLTFI/HelloWorld.cpp"
#include "../../include/LLTFI/ConvInjectFault.cpp"
#include "../../include/LLTFI/InjectFault.cpp"
...
int main(int argc, char **argv) {
  ...
  // LLTFI Passes
  registerCountAddOperationsPass();
  registerConvInjectFaultPass();
  registerConvInjectFaultPass1();
